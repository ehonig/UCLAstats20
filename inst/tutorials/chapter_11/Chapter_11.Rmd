...
```{r hist, exercise = TRUE, fig.align='center', fig.asp=1, out.width='100%', cache=TRUE}
hist(phats,
...
```{r bus, exercise = TRUE, fig.align='center', fig.asp=1, out.width='100%', cache=TRUE}
## Set the seed for reproduceability
set.seed(24601)
...
```{r dnorm, exercise = TRUE, fig.align='center', fig.asp=1, out.width='100%', cache=TRUE}
## Set the seed for reproduceability
set.seed(321)
...
```{r curve, exercise = TRUE,fig.align='center',fig.asp=1,out.width='100%',cache=TRUE}
