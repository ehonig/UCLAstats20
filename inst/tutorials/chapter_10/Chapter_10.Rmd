...
# options(width = 80)
# tutorial_options(exercise.completion = FALSE, exercise.checker = checker)
>>>>>>> bb045639fd87bbd80fb84363a4d060e973cb70c1
...
```{r treehist,fig.align='center',fig.asp=1,out.width='100%', exercise=TRUE}
hist(trees$Girth)
```
...
```{r modifyhist,fig.align='center',fig.asp=1,out.width='100%', exercise = TRUE}
hist(
  trees$Girth,
  breaks = 10,
  freq = FALSE,
...
```{r birthbox,fig.align='center',fig.asp=1,out.width='100%', exercise=TRUE}
...
```{r boxform1,fig.align='center',fig.asp=1,out.width='100%', exercise=TRUE}
...
```{r boxform2,fig.align='center',fig.asp=1,out.width='100%',exercise=TRUE}
...
```{r barplot1, exercise = TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r stacked, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r beside, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r color, exercise= TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r plot1, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r plot2, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%',eval=FALSE}
...
```{r single, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2)
```
...
```{r super, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2, type = "b", pch = 2, cex = 1.3, col = "blue")
```


```{r plotquiz, echo=FALSE}
...
```{r dataplot,exercise=TRUE, fig.align='center',fig.asp=1,out.width='100%'}
pairs(trees)
```

If we apply the `plot()` function to a data frame, the `plot()` function gives the same output as `pairs()`.

```{r dataplot2, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r plotpt, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r plotptmat, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r volhigh, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r volhigh-solution,fig.align='center',fig.asp=1,out.width='100%'}
## Find the observations (trees) with an above average (mean) volume
...
```{r lines, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot(Girth ~ Height, data = trees)
...
```{r lines2, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot(Girth ~ Height, data = trees)
...
```{r kerden, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r plottext, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2)
text(5, 40, "y = x^2")
```
...
```{r express, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2)
...
```{r finaltext, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r uselocate, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%',eval=FALSE}
hist(trees$Girth)
...
```{r abline_intro, exercise=TRUE, fig.align='center',fig.asp=1,out.width='100%'}
...
```{r prettyabline, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r vhlines, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2, xlim = c(0, 10))
abline(0, 10, col = "red", lty = 3, lwd = 2.5)
...
```{r seqabline, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
plot((1:10)^2, xlim = c(0, 10))
...
```{r regline1, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r sumlm, exercise=TRUE}
summary(lm_trees)
```

```{r reglineq2, echo = FALSE}
...
```{r legend, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r legend-solution,fig.align='center',fig.asp=1,out.width='100%'}
## Construct a relative frequency histogram of Girth
hist(trees$Girth, prob = TRUE)
## Superimpose a density curve
...
```{r legend-check,fig.align='center',fig.asp=1,out.width='100%'}
## Construct a relative frequency histogram of Girth
hist(trees$Girth, prob = TRUE)
## Superimpose a density curve
lines(density(trees$Girth), lwd = 2, col = "green")
...
```{r addhist, exercise=TRUE,fig.align='center',fig.asp=1,out.width='100%'}
...
```{r layout, exercise = TRUE,fig.align='center', fig.height=10, fig.width=9}
par(mfrow = c(2, 3))
hist(trees$Girth)
hist(trees$Height)
hist(trees$Volume)
